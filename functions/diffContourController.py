...
from functions.contours import generate_difference_contour, plot_contour

# Defining directories
environ["DYLD_LIBRARY_PATH"] = "/Applications/COMSOL63/Multiphysics"
path = environ["DYLD_LIBRARY_PATH"]
